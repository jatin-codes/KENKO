...
export default class screen2 extends Component {
  ...
  sendText = () => {
    ...
    console.log("WORKS?")
    fetch(`https://xdhacks-server.netlify.com/.netlify/functions/sendText?number=${text.recipient}}&body=${text.textmessage}`)
            ...
            <View style={styles.logoContainer}>
              ...
              <View style={styles.infoContainer}>
                ...
                <TextInput style={styles.input}
                  ...
                  ref={"txtPassword"}
                /> */}
                <TouchableOpacity onPress={() => this.sendText()} style={styles.buttonContainer}>
